            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <button data-route="{{ route('admin.customers.bulk_delete') }}" type="button" id="bulk-delete-btn" class="btn btn-danger" disabled>Delete Selected</button>
                    </div>
                </div>
            </div>
        </div>
              ...
              <div class="card">
                  ...
                  <div class="d-flex">
                    <div class="text-secondary">
                      ...
                      <div class="mx-2 d-inline-block">
                        <select name="limit" onchange="updateData(this)" data-route="{{ route('admin.customers.index') }}"> 
                ...
                <div class="table-responsive">
                  <table class="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tr>
                        <td><input class="form-check-input m-0 align-middle selected-item" type="checkbox" value="{{ $customer->id }}" aria-label="Select invoice"></td>
                        <td><span class="text-secondary">{{ $customer->id }}</span></td>
                        <td><a href="{{ route('admin.customers.show', $customer->id) }}" class="text-reset" tabindex="-1">{{ $customer->name }}</a></td>
                        <td><span class="text-secondary">{{ $customer->email }}</span></td>
                        <td><span class="text-secondary">{{ $customer->phone }}</span></td>

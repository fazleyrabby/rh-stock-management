                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Customer preview</h3>
                        </div>
                        <div class="card-body">
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                <label class="col-3 col-form-label required">Product Email</label>
                                <div class="col">
                                    {{ $customer->email }}
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-3 col-form-label required">Product phone</label>
                                <div class="col">
                                    {{ $customer->phone }}
                                </div>
                            </div>

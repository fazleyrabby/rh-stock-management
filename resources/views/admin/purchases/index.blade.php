              ...
              <div class="card">
                  ...
                  <div class="d-flex">
                    <div class="text-secondary">
                      ...
                      <div class="mx-2 d-inline-block">
                        <select name="limit" onchange="updateData(this)" data-route="{{ route('admin.purchases.index') }}"> 
                ...
                <div class="table-responsive">
                  <table class="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tr>
                        <td><input class="form-check-input m-0 align-middle selected-item" type="checkbox" value="{{ $purchase->id }}" aria-label="Select invoice"></td>
                        <td><span class="text-secondary">{{ $purchase->id }}</span></td>
                        <td><a href="{{ route('admin.purchases.show', $purchase->id) }}" class="text-reset" tabindex="-1">{{ $purchase->purchase_number }}</a></td>
                        <td><span class="text-secondary">{{ $purchase->supplier->name }}</span></td>
                        <td><span class="text-secondary">{{ $purchase->total_amount }}</span></td>

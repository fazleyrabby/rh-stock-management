                                ...
                                <div class="col">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="products-table">
                                            ...
                                            <tr>
                                                <td>
                                                    <select type="text" class="form-select" id="product" name="products[{{ $key }}][product_id]" value="">
                                                        @foreach ($products as $index => $value)
                                                            <option value="{{ $index }}" @selected($purchaseProduct->product_id == $index)>{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td><input type="number" class="form-control" name="products[{{ $key }}][quantity]" value="{{ $purchaseProduct->quantity }}"></td>
                                                <td><input type="text" class="form-control"  name="products[{{ $key }}][price]" value="{{ $purchaseProduct->price }}"></td>

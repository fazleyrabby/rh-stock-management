...
@section('title', 'Stock Movements List')
@section('content')
    <!-- Page header -->
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('admin.stocks.movement.create') }}" class="btn btn-primary">
              ...
              <div class="card">
                  ...
                  <div class="d-flex">
                    <div class="text-secondary">
                      ...
                      <div class="mx-2 d-inline-block">
                        <select name="limit" onchange="updateData(this)" data-route="{{ route('admin.stocks.movement.index') }}"> 
                ...
                <div class="table-responsive">
                  <table class="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tr>
                        <td><input class="form-check-input m-0 align-middle selected-item" type="checkbox" value="{{ $stockMovement->id }}" aria-label="Select invoice"></td>
                        <td><span class="text-secondary">{{ $stockMovement->id }}</span></td>
                        <td><a href="{{ route('admin.stocks.movement.show', $stockMovement->id) }}" class="text-reset" tabindex="-1">{{ $stockMovement->product->title }}</a></td>
                        <td><span class="text-secondary">{{ $stockMovement->type }}</span></td>
                        ...
                        <td class="text-end">
                          <span class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                              <a class="dropdown-item" href="{{ route('admin.stocks.movement.edit', $stockMovement->id) }}">
                                Edit
                              </a>
                              <form onsubmit="return confirmDelete(event, this)"
                                  action="{{ route('admin.stocks.movement.destroy', $stockMovement->id) }}"
                                  method="post">
                                  @csrf
                                  @method('delete')
